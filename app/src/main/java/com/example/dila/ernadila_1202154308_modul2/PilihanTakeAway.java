...
public class PilihanTakeAway extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilihan_take_away);
    ...
    public void pilihpesan(View view) {
        ...
        Intent c = new Intent(PilihanTakeAway.this, List.class);
        startActivity(c);
    }
